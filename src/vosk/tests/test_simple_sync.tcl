#!/usr/bin/env tclsh
# test_simple_sync.tcl - Test simple synchronous Vosk API

package require critcl
set auto_path [linsert $auto_path 0 [file join [pwd] lib]]

puts "Testing simple synchronous Vosk API..."
...
puts "Processing test audio data 10 times synchronously..."
...
puts "✅ Simple synchronous test completed successfully!"