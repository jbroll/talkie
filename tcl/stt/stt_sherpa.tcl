...
proc critcl::module { mod } { info script $mod }
critcl::cflags -fPIC
...
static int sherpa_create_recognizer(ModelCtx *model_ctx, Tcl_Interp *interp, int sample_rate) {
    ...
    rec_ctx->cmdname = Tcl_NewStringObj(cmd_name, TCL_AUTO_LENGTH);
...
int SherpaCreateModelCmd(ClientData cd, Tcl_Interp *interp, int objc, Tcl_Obj *const objv[]) {
    ...
    ctx->cmdname = Tcl_NewStringObj(cmd_name, TCL_AUTO_LENGTH);
...
package provide stt_sherpa 1.0